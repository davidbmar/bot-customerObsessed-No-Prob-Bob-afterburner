...
Merge Order
1. agentA-multi-project-vision

Merge Verification
```bash
cd /Users/davidmar/src/bot-customerObsessed-No-Prob-Bob-afterburner
.venv/bin/python3 -c "from bot.tools import generate_vision; print('generate_vision: OK')"
.venv/bin/python3 -c "from bot.config import BotConfig; c = BotConfig.load(); print('Projects:', len(c.projects) if hasattr(c, 'projects') else 'single')"
