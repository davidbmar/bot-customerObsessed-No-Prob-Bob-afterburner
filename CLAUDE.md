# Claude Instructions — afterburner-customer-bot
...
PROJECT_ROOT=/Users/davidmar/src/afterburner-customer-bot OUTPUT_DIR=<framework>/dist/projects/afterburner-customer-bot/data ./scripts/build-sprint-data.sh
```
