...
Merge Order
1. agentA-fixes-and-polish

Merge Verification
```bash
cd /Users/davidmar/src/bot-customerObsessed-No-Prob-Bob-afterburner
.venv/bin/python3 cli.py status 2>&1 | head -5
.venv/bin/python3 -c "from bot.tools import generate_vision, feedback_on_sprint; print('Tools: OK')"
