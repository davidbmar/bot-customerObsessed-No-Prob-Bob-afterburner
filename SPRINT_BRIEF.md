...
Merge Order
1. agentA-input-filter-fastpath
2. agentB-hands-free-vad

Merge Verification
```bash
cd /Users/davidmar/src/bot-customerObsessed-No-Prob-Bob-afterburner
.venv/bin/python3 -c "from bot.input_filter import classify, InputQuality; print('InputFilter: OK')"
.venv/bin/python3 -c "from bot.fast_path import try_fast_path; print('FastPath: OK')"
