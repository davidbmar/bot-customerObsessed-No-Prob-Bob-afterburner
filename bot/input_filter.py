...
Ported from voice-calendar-scheduler-FSM/engine/input_filter.py.

Combines multiple signals to classify transcriptions as VALID, GARBAGE, or
LOW_QUALITY. Saves LLM cost and latency by rejecting noise early.
...
_HALLUCINATION_PATTERNS = [
    ...
    re.compile(r'^(\w+)(?:\s+\1){2,}\s*$', re.I),  # Repeated word: "the the the"
