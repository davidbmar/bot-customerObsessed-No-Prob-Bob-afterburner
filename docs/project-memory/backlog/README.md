...
| B-037 | Bot says "I'm text-only" and "I can't hear audio" when user speaks via voice — personality system prompt doesn't mention STT/TTS voice capabilities | High | Open |
